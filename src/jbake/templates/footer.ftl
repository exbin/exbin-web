    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">&copy; ExBin Project 2016 | Mixed with <a href="http://getbootstrap.com/">Bootstrap v3.1.1</a> | Baked with <a href="http://jbake.org">JBake ${version}</a></p>
      </div>
    </div>
